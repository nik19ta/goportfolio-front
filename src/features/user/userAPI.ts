...
export const fetchProfile = async (shortname: string):
  Promise<AxiosResponse<ProfileResp>> => {
...
export const fetchCategories = async (shortname: string):
...
export const fetchProjects = async (shortname: string):
...
export const getProjectByUUID = async (uuid: string):
  Promise<AxiosResponse<RespGetProjectById>> => {
